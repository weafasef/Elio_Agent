...
世界观作为 user message 进入对话历史，自然累积——Elio 能"看到"时间流逝。系统提示词中 "Understanding the conversation — the time-slice clock" 段告知 Elio 区分世界观时钟信号和主人真实话语。
...
加入系统状态（CPU、内存）、主人活动检测（键盘/鼠标空闲时间）。
